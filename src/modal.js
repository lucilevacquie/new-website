      ...
      <motion.div
        ...
        className={classNames(
          isFirefoxBrowser
            ...
            : (isActive ? "pointer-events-auto" : "pointer-events-none",
              "overflow-auto backdrop-filter backdrop-blur-lg z-30 pt-24 px-8 pb-8 sm:py-12 sm:px-48 h-full w-full bg-white bg-opacity-25 bg-clip-padding rounded-small sm:rounded-large")
        )}
      >
